...
class TorchResNet18(Pruneable):

    def __init__(self, device="cuda", output_dim=2, input_dim=(1, 1, 1), **kwargs):
        super(TorchResNet18, self).__init__(device=device, output_dim=output_dim, input_dim=input_dim, **kwargs)
...
if __name__ == '__main__':
    ...
    for test_batch in [mnist, cifar, imagenet]:
        conv = TorchResNet18(output_dim=10, input_dim=test_batch.shape[1:], device=device)
